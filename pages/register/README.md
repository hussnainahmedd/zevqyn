...
**Production URL:** https://zevqyn.free.je/register/
**WordPress Slug:** `register`

## Description

Registration page with Supabase Auth. Custom HTML/CSS/JS form embedded in Greenshift block layout. Client-side validation with email verification flow.
